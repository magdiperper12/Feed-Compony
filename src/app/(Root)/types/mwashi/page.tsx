...
function Mawashi() {
	const SecoundFiveItems = shekaraItems.slice(13, 19);
	...
	return (
		<div className='mt-20 px-4 w-full mx-auto'>
			...
			<div className='max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-12 py-14'>
				{SecoundFiveItems.map((item, index) => (
					<div
						key={index}
